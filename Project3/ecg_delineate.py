# -*- coding: utf-8 -*-
# Copied this code from neurokit and changed it so it doesn't return nan in peaks
...
from neurokit2.signal import signal_findpeaks, signal_formatpeaks, signal_resample, signal_smooth, signal_zerocrossings
