from Project4.InceptionTime.utils.constants import UNIVARIATE_ARCHIVE_NAMES as ARCHIVE_NAMES

from Project4.InceptionTime.utils.utils import read_all_datasets
from Project4.InceptionTime.utils.utils import transform_labels
from Project4.InceptionTime.utils.utils import create_directory
from Project4.InceptionTime.utils.utils import run_length_xps
from Project4.InceptionTime.utils.utils import generate_results_csv

import Project4.InceptionTime.utils
import numpy as np
import sys
import sklearn
...
def create_classifier(classifier_name, input_shape, nb_classes, output_directory,
    ...
    if classifier_name == 'nne':
        from Project4.InceptionTime.classifiers import nne
        return nne.Classifier_NNE(output_directory, input_shape,
                                  nb_classes, verbose)
    if classifier_name == 'inception':
        from Project4.InceptionTime.classifiers import inception
...
############################################### main
root_dir = '/Users/danielkiesewalter/Documents/Uni/Master/AML/Project4'
...
if sys.argv[1] == 'InceptionTime':
    ...
    for iter in range(nb_iter_):
        ...
        for dataset_name in Project4.InceptionTime.utils.constants.dataset_names_for_archive[archive_name]:
